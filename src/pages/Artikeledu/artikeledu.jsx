...
import Gambarmanajemenstres from "../../assets/image/manajemenstres.png";
          ...
          <div className="flex-1 lg:mr-8">
            ...
            <article className="bg-[#F9FAF9] p-6 rounded-lg shadow-md mb-8 lg:mb-0">
              ...
              <div className="flex justify-center mb-6">
                <img
                  src={Gambarmanajemenstres}
                  alt="Man holding a paper with a sad face"
              ...
              <div className="flex flex-col lg:flex-row mb-6 text-[#04364A]">
                ...
                <div className="lg:w-3/4 text-justify">
                  <p className="mb-4">
                    ...
                    tentang kesehatan mental dan bagaimana kita dapat merawatnya
                    dengan baik.
                  </p>
                  <section className="mb-4">
                    <h2 className="text-xl font-bold mb-2">Kesehatan Mental</h2>
                    <p>
                      Kesehatan mental adalah kondisi di mana seseorang memiliki
                      kesejahteraan yang tampak, mampu menyadari potensi
                      dirinya, mengatasi tekanan hidup, bekerja secara
                      produktif, dan memberikan kontribusi kepada komunitas.
